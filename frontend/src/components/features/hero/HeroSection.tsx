...
export function HeroSection({ config }: HeroSectionProps) {
  ...
  return (
    <section className="relative h-[520px] w-full overflow-hidden lg:h-[680px]">
      {/* Background image */}
      {heroImageUrl && (
        <img
          src={heroImageUrl}
      ...
      {/* Content */}
      <div className="relative flex h-full flex-col justify-end gap-5 px-5 pb-12 lg:justify-start lg:gap-7 lg:px-14 lg:pt-[120px]">
        {/* Tag */}
        ...
        {/* Title */}
        <h1 className="max-w-[340px] font-display text-[34px] font-extrabold leading-[1.1] tracking-[-1px] text-text-primary lg:max-w-[680px] lg:text-[56px] lg:leading-[1.05] lg:tracking-[-2px]">
          {config?.heroTitle ??
            'Tu lugar para\ncrecer, conectar\ny transformarte.'}
        </h1>

        {/* Subtitle */}
        <p className="max-w-[300px] font-body text-[15px] leading-[1.5] text-text-secondary lg:max-w-[520px] lg:text-[17px] lg:leading-[1.6]">
          {config?.heroSubtitle ??
