...
function formatEventMeta(event: CalendarEvent): string {
      ...
      <div className="flex flex-col gap-3 lg:flex-row lg:gap-4">
        {upcoming.map((event, index) => {
          ...
          return (
            <div
              key={event.id}
              className="flex items-center gap-3 rounded-xl border border-border bg-bg-card p-3.5 lg:flex-1 lg:gap-3.5 lg:p-4"
            >
              {/* Date badge */}
              <div
